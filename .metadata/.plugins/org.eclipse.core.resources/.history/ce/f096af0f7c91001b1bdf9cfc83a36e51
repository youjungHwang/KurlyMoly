...
public class OrderDTO {
	...
	private String oShipdtate; // 처리상태 : 미확인/상품준비중/배송중/배송완료/구매확정
	...
	public String getoShipdtate() {
		return oShipdtate;
	}
	public void setoShipdtate(String oShipdtate) {
		this.oShipdtate = oShipdtate;
	}
	...
	public String toString() {
		return "OrderDTO [oIdx=" + oIdx + ", oUserid=" + oUserid + ", oOrderer=" + oOrderer + ", oReceiver=" + oReceiver
				...
				+ ", oShipstart=" + oShipstart + ", oShipdone=" + oShipdone + ", oShipdtate=" + oShipdtate
