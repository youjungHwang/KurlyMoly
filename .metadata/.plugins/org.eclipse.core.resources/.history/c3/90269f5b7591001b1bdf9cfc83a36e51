...
<body>
    ...
    <div id="container">
        ...
        <header id="header">
            ...
            <div id="headerLogo">
                <h1 class="logo"><a href="./index.html" class="link_main"><img src="./img/logo_x2.webp" alt="마켓컬리 로고"
                            style="display: block;"></a></h1> <!-- 메인로고 -->
            </div>

            <div id="gnb">
                <div id="gnbMenu" class="gnb_kurly">
                    <!-- 1050*56 전체를 한번 감싸줘서 스크롤을 내렸을때 메뉴바 아래에 그림자가 생겨야 함 -->
                    <div class="inner_gnbkurly">
                        ...
                        <div class="gnb_sub" style="display: none; width: 219px;">
                            <!-- 평소에는 감춰져있다가, 마우스 호버시 block으로 표시 -->
                            <div class="inner_sub">
                                <ul class="gnb_menu" style="height: auto;" data-default="219" data-min="219"
                                    ...
                                    <li>
                                        <a class="menu">
                                            <span class="ico">
                                                <img src="./img/mainMenu/ico_recommend_v2.webp" alt="카테고리 아이콘 off"
                                                    class="ico_off">
                                                <img src="./img/mainMenu/ico_recommend_on_v2.webp" alt="카테고리 아이콘 on"
                                                    class="ico_on">
                                            </span>
                                            <span class="tit">
                                        ...
                                        <ul class="sub_menu">
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_diet.1585551225.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_breakfast.1585549149.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_kp_best_201207.1607408493.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_kp_3000_201207.1607408565.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_kp_210108_4.1610088265.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_single.1594026881.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/category_kurly_s-pick_thumbnail_shrimp.1589797274.png"></span>
                                                    <span class="name">뚝딱! 간편식</span>
                                                </a>
                                            </li>
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumb_kp_bakery_201217.1608624742.jpg"></span>
                                                    <span class="name">베이커리 맛집</span>
                                                </a>
                                            </li>
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail.1598235634.jpg"></span>
                                                    <span class="name">반찬가게</span>
                                                </a>
                                            </li>
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/Thum_Cytogenic.1592469678.jpg"></span>
                                                    <span class="name">키토제닉</span>
                                                </a>
                                            </li>
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/Thum_vegan.1592469659.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/Thum_sustainable.1589875827.jpg"></span>
                                                    <span class="name">지속가능한 상품</span>
                                                </a>
                                            </li>
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/pb.1594027365.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumbnail_kp_only_201207.1607408395.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/kf3651016.1602814588.jpg"></span>
                                            ...
                                            <li class="recommend">
                                                <a class="sub">
                                                    <span class="thumb"><img
                                                            src="./img/mainMenu/thumb_kp_1PT_201222.1608611417.jpg"></span>
            ...
            <div id="content" class="Eve">
                <div id="qnb" class="quick-navigation" style="top: 0px;">
                    <div class="bnr_qnb" id="brn_Quick">
                        <a href="./shop/board/delivery.html"><img class="thumb"
                    ...
                    <div class="side_recent">
                        ...
                        <div class="list_goods" data-height="209" style="height: 160px;">
                            <ul class="list">
                                <li><a class="link_goods" href="#"><img src="#"></a></li>
                                <!-- 가장 최근에 본 상품의 링크와 이미지 가져오기 ★★★★★ -->
                                <!-- <li><a class="link_goods" href="#"><img src="#"></a></li> 가장 최근에 본 상품의 링크와 이미지 가져오기 ★★★★★ -->
                            </ul>
                        </div>
                        <button type="button" class="btn btn_down">최근 본 상품 아래로 올리기</button>
                    </div>
                    <!-- <script>
                        /**
