                            ...
                            <div class="page_aticle aticle_type2 clear">
                                ...
                                <div class="page_section section_write">
                                    ...
                                    <form name="form_review" id="form_review" method="POST"
                                        ...
                                        <input type="hidden" name="goodsno" value="53932">
                                        <input type="hidden" name="ordno" value="1613981249796">
                                        ...
                                        <div class="write_board">
                                            <div class="goods_info">
                                                <div class="thumb">
                                                    <img src="../../img/mypage/상품이미지.webp" alt="상품 이미지">
                                                </div>
                                                <div class="desc">
                                                    <div class="inner_desc">
                                                        <div class="name_main">[한판] 치즈 부대찌개 1858g(냉장)</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <table class="tbl">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>제목</th>
                                                        <td><input type="text" name="subject" placeholder="제목을 입력해주세요"
                                                                class="inp" value=""></td>
                                                    </tr>
                                                    <tr>
                                                        <th>후기작성</th>
                                                        <td>
                                                            <div class="field_cmt">
                                                                <textarea name="contents" id="fieldCmt" cols="100"
                                                                    rows="10"
                                                            ...
                                                            <div class="photo_add">
                                                                ...
                                                                <span class="btn_upload">
                                                                    <input type="file" name="file[]" class="file_upload"
                                                                        onchange="" value="사진등록하기" accept="image/*">
                                                                </span>
                                                            </div>
                                        ...
                                        <p class="link_inquire">혹시 상품에 문제가 있으셨나요? <a href=""> 1:1 문의하기</a></p>
