                                        ...
                                        <ul class="list_before">
                                            <li>
                                                <strong class="tit_item">
                                                    <span class="emph"> 주문번호</span>
                                                    1613981249796
                                                </strong>
                                                <div class="item">
                                                    <a href="" class="thumb"><img src="../../img/mypage/상품이미지.webp"
                                                            alt="상품이미지"></a>
                                                    <div class="name">
                                                        <div class="inner_name">
                                                            <a href="" class="main_name">[한팟] 치즈 부대찌개 1858g(냉장)</a>
                                                            <span class="num">1개 구매</span>
                                                        </div>
                                                    </div>
                                                    <div class="date">
                                                        <div class="inner_date">
                                                            <div class="in_date">
                                                                <span class="start">02월23일 배송완료</span>
                                                                <span class="end"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <a href="" class="btn_write">후기쓰기</a>
                                                </div>
                                            </li>
                                            <li>
                                                <strong class="tit_item">
                                            ...
                                            <li class="">
                                                ...
                                                <div class="cont_after">
                                                    <a class="desc_after">
                                                        <span class="subject">
                                                            간편하게 바삭, 탕수육
                                                            <span class="date">21.02.21 작성</span>
                                                        </span>
                                                        <span class="desc">
                                                            <span class="img"></span>
                                                            <span class="txt">
                                                                찹쌀탕수육 처럼 겉은 바삭하고 속은 쫀득한 것이 아주 농밀하게 혀를 감싸주는데, 어찌나 야무진
                                                                놀림인지
                                                                앞마당에 있는 우리집 댕댕이 봉숙이도 놀라고 하늘도 놀랄지경이며 아랫집 스님도 고기튀겨지는 냄새에
                                                                석가모니를 유혹하던 제육천마왕의 딸들 처럼 출가전 마지막으로 먹었던 탕수육의 향의 기억이 새초롬하게
                                                                머리를 스쳐지나가 침을 흘리며 우리집으로 뛰어들어오실 뻔 하셨거늘 이내 탕수육 소스를 붓는 것을 보고
                                                                열반으로의 정진을 위해 눈물을 머금으며 절로 돌아가사 이를 두고 경천동지할 탕수육이라 어찌 아니 부를
                                                                수 있을까?
                                                            </span>
                                                        </span>
                                                        <span class="view">
                                                            <span class="img"></spanc>
                                                                <span class="txt">찹쌀탕수육 처럼 겉은 바삭하고 속은 쫀득한 것이 아주 농밀하게 혀를
                                                                    감싸주는데, 어찌나 야무진 놀림인지
                                                                    <br>앞마당에 있는 우리집 댕댕이 봉숙이도 놀라고 하늘도 놀랄지경이며 아랫집 스님도
                                                                    고기튀겨지는 냄새에
                                                                    <br>석가모니를 유혹하던 제육천마왕의 딸들 처럼 출가전 마지막으로 먹었던 탕수육의 향의
                                                                    기억이 새초롬하게
                                                                    <br>머리를 스쳐지나가 침을 흘리며 우리집으로 뛰어들어오실 뻔 하셨거늘 이내 탕수육 소스를
                                                                    붓는 것을 보고
                                                                    <br>열반으로의 정진을 위해 눈물을 머금으며 절로 돌아가사 이를 두고 경천동지할 탕수육이라
                                                                    어찌 아니 부를 수 있을까?<br></span>
                                                            </span>
                                                    </a>
                                                    <div class="btn_after">
                                                        <button type="button" class="btn_help">도움이 돼요 0</button>
                                                        <a class="btn btn_modify">수정</a>
                                                        <a class="btn btn_deit">삭제하기</a>
                                                    </div>
                                                </div>
