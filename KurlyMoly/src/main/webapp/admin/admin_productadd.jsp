    ...
    <div id="wrap">
        ...
        <div class="container clear">
            ...
            <div id="content">
                ...
                <form name="fm" id="fm"class="regForm" method="post" action="admin_productadd_ok.jsp"  enctype="multipart/form-data" >
                    ...
                    <ul class="reg_list reg_list_category" >
                        ...
                        <li class="prod_category">
	                        <select class="select_category" name="category1" size=8 >    
	                            ...
	                            <option value="018">컬리의 추천</option>
                            </select>      
                        ...
                        <div class="prod_inner">
                            <li class=" clear">
                                ...
                                <div class="search_box"> 
                                    <input class="long_input" type="text" name="title"><span class="print_bytes"> 0 / 100 </span>
                                </div>
                            </li>
                            <div class="hr"> </div>
                            <li class="clear">
                                ...
                                <div class="search_box"> 
                                    <input class="long_input" type="text" name="subtitle"><span class="print_bytes"> 0 / 100 </span>
                                </div>
                            </li>
                            <div class="hr"> </div>
                            <li class="clear">
                            ...
                            <li class="clear">
                                ...
                                <div class="search_box"> 
                              <input class="short_input" type="text" name="price" placeholder="숫자만 입력"><span class="print_units"> 원 </span> 
                                </div>
                            </li>
                            <div class="hr"> </div>
                            <li class="clear">
                                ...
                                <div class="search_box"> 
                                    <input class="short_input" type="text" name="discprice" placeholder="숫자만 입력"><span class="print_units" > 원 </span> 
                                </div>
                            </li>
                             <div class="hr"> </div>
                             <li class="clear">
                                ...
                                <div class="search_box"> 
                                    <input class="short_input" type="text" name="point" placeholder="숫자만 입력"><span class="print_units"> 점 </span> 
                                </div>
                            </li>
                            <div class="hr"> </div>
                            <li class="clear">
                                ...
                                <div class="search_box" > 
                                    <input class="short_input" type="text" name="stock" placeholder="숫자만 입력"><span class="print_units"> 개 </span> 
                                </div>
                ...
                <div class="productadd">
                    ...
                    <div class="prod_inner">
                        ...
                        <li class="clear">
                            ...
                            <div class="search_box"> 
                          <input class="middle_input" type="text" name="salesunit"> 
                            </div>
                        </li>
                        <div class="hr"> </div>
                        <li class="clear">
                            ...
                            <div class="search_box"> 
                          <input class="middle_input"  type="text" name="weight"> 
                            </div>
                        </li>
                        <div class="hr"> </div>
                        <li class="clear">
                            ...
                            <div class="search_box"> 
                          <input class="middle_input"  type="text" name="origin"> 
                            </div>
                        </li>
                    </div>
                    </ul>
                    ...
                    <div class="prod_inner">
		                <li class="search_detail clear">
		                    ...
		                    <label class="tit_lbl_search">대표이미지</label>
		                     <div >
			                     <input type="file" multiple=multiple id="input_img" name='imgname' style='display: none;' />
