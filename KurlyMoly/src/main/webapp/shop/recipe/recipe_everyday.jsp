						...
						<div id="lnbMenu" class="lnb_menu">
							<div class="inner_lnb">
								...
								<ul class="list">
									...
									<li><a class="on" href="./recipe_everyday.jsp">매일밥상</a></li>
																...
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/975b07be2baba9ae" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/9ce15cfc1b3e571b" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/ffad2d8e18ce6b35" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/5cc6a45945c5132f" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/ee105f9f395e7c73" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/dbbb42b102f85311" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">땅콩 호박 라구</p>
																			</a>
																		</li>
																	</ul>
																</div>
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/752faca336c32a93" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">짜장밥</p>
																			</a>
																		</li>
																	</ul>
																</div>
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/3c975dd8e25fb955" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">토종닭 캐슈넛볶음</p>
																			</a>
																		</li>
																	</ul>
																</div>
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/c570f07948f2fcde" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">꼬리곰탕</p>
																			</a>
																		</li>
																	</ul>
																</div>
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/792df50826159494" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">도다리 냉이국</p>
																			</a>
																		</li>
																	</ul>
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/51a83cde2c8cdaaf" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">아몬드 오징어채 무침</p>
																			</a>
																		</li>
																	</ul>
																</div>
															...
															<td align="left" valign="top">
																<div>
																	<ul>
																		<li class="recipe_item">
																			<a href="#">
																				<img src="//img-cf.kurly.com/shop/data/board/recipe/r/2cbcb6abaac6e706" width="480" height="480" onerror="this.src=&quot;/shop/data/skin/designgj/board/gallery/img/noimg.gif&quot;">
																				<p class="tit_recipe">버섯들깨탕</p>
																			</a>
																		</li>
																	</ul>
																</div>
																...
																<table class="xans-board-search xans-board-search2">
																	<tbody>
																		<tr>
																			...
																			<td class="stxt" style="text-align: left"><input type="checkbox" name="search[name]">이름 <input type="checkbox" name="search[subject]">제목 <input type="checkbox" name="search[contents]">내용 <input type="checkbox" name="search[tag]">태그 &nbsp;</td>
