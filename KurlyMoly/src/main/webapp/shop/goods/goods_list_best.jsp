...
<c:set var="highstockList" value="${productDAO.highstockList()}" />
<!-- 재고 많은순 -->
				...
				<div id="content">
					...
					<div class="page_article new_article">
						...
						<div id="goodsList" class="page_section section_goodslist">
                            ...
                            <label for="list_switch" class="list_round"></label> -->
							<!--정렬기능
							<div class="sort_menu">
								<div class="">
									<div class="select_type user_sort checked">
										<a class="name_select">인기상품순</a>
										<ul class="list">
											<li><a class="" href="#">추천순</a></li>
											<li><a class="" href="./goods_list_new.jsp">신상품순</a></li>
											<li><a class="on" href="./goods_list_best.jsp">인기상품순</a></li>
											<li><a class="" href="./goods_list_sales.jsp">혜택순</a></li>
										</ul>
									</div>
								</div>
							</div>-->
							...
							<div id="goodsList_inner">
								<div id="goodsList_inner_box">
									<ul class="goodsList_list">
										...
										<c:forEach var="item" items="${highstockList}"
											varStatus="status">
											<li>
												<div class="item">
													<div class="product_part">
														...
														<!--장바구니 버튼-->
														<div class="chart_btn" onclick="return false"> <!-- ################################################## 추가!!!!!!!!!! -->
													...
													<div class="product_info">
														...
														<span id="cost"> <fmt:parseNumber
																value="${item.price}" var="price" /> <fmt:parseNumber
																value="${item.discprice}" var="discprice" /> <fmt:parseNumber
																value="${(price-discprice)/price*100}" var="percent"
																pattern="00." integerOnly="true" /> <c:if
																test="${percent gt 1 }">
																<!-- 가격 할인 있을때만, 상품 할인퍼센트 표시  -->
																<span class="sale">${percent}%</span>
															</c:if> <span class="cost">${item.discprice}원</span> <c:if
																test="${percent gt 1 }">
