...
<c:set var="lowestList" value="${productDAO.lowestList()}" />
<!-- 낮은 가격순 -->
			...
			<div id="goods_main">
				...
				<div id="content">
					...
					<div class="page_article new_article">
						<!--늘 기분 좋은 가격 링크 시작-->
						<div id="sale_link">
							<a href="./event_list.jsp"><img src="../../img/goods_list/sale_link.jpg" alt="늘 기분 좋은가격 링크"></a>
						</div>
						<!--늘 기분 좋은 가격 링크 종료-->
						<!--세부 카테고리 바 시작-->
						<div id="top_menu">
							<div id="new_logo_menu">
								<span><h3>알뜰쇼핑</h3></span>
							</div>
							...
							<div id="goodsList_inner">
								<div id="goodsList_inner_box">
									<ul class="goodsList_list">
										...
										<c:forEach var="item" items="${lowestList}" varStatus="status">
											<li>
												<div class="item">
													...
													<div class="product_info">
														...
														<span id="cost">
															<fmt:parseNumber value="${item.price}" var="price" /> <fmt:parseNumber
					...
					<div class="list_goods">
						<ul class="list list_nopackage">
							<li class="on"><span class="btn_position"><button
									...
									</button></span> <span class="name"> [KF365] 아보카도 1개 </span> <!--value값 1로 디폴트-->
								<div class="option">
					...
					<div class="total">
						<div class="price">
							<strong class="tit">합계</strong> <span class="sum"><span
								class="num">2,340</span> <span class="won">원</span></span>
						</div>
						<p class="txt_point">
