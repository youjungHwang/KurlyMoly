...
<%
	String userid = null;
	if (session.getAttribute("userid") != null) { // username != sql에 저장된 이름??? m_name로 안해도 되는건지 체크 필요
                ...
                <div id="content" style="padding-bottom: 120px;">
                    ...
                    <div class="section_login">
                        ...
                        <div class="write_form find_view">
                            <form id="form" name="fm" method="post" action="find_id_confirm.jsp" onsubmit="return chkForm(this);">
                                <input type="hidden" name="act" value="Y">
                                <input type="hidden" name="rncheck" value="none">
                                <input type="hidden" name="dupeinfo" value="">
                                <strong class="tit_label">이름</strong>
                                <input type="text" name="srch_name" tabindex="2" size="29" required="required"
                                    placeholder="고객님의 이름을 입력해주세요">
                                <strong class="tit_label">이메일</strong>
                                <input type="text" name="srch_mail" size="29" tabindex="5" required="required"
