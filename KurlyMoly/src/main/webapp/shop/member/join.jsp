								...
								<table class="tbl_comm">
									<tbody>
										...
										<tr>
											...
											<td><input type="text" name="mName" label="이름" placeholder="이름을 입력해주세요"></td>
										</tr>
										<tr>
										...
										<tr class="field_phone">
											...
											<td>
												<div class="phone_num">
													...
													<button id="btn_cert" class="btn default" type="button" onclick="alert('인증이 확인되었습니다.')">인증번호 받기</button>
												</div>
										...
										<tr>
											...
											<td>
												<input type="text" name="mZipcode" value="" readonly="readonly" label="주소" size="30" placeholder="우편번호를 입력해주세요" id="sample6_postcode">
										...
										<tr>
											...
											<td class="field_address"><input type="text" name="mAddress1" id="sample6_address1" placeholder="주소를 입력해주세요"></td>
										</tr>

										<tr>
											<th>상세주소<span class="ico">*<span class="screen_out">필수항목</span></span></th>
											<td class="field_address">
												<input type="text" id="sample6_detailAddress1" name="mAddress2" placeholder="나머지 주소를 입력해주세요">
												<div id="selectAddress">
											</td>
										</tr>
										<input type="hidden" id="sample6_extraAddress1">
										...
										<tr class="select_sex">
											<th>성별</th>	
											<td>
												<label class=""> <input type="radio" name="mGender" value="남자"> <span class="ico"></span>남자</label>
												<label class=""> <input type="radio" name="mGender" value="여자"> <span class="ico"></span>여자</label>
												<label class="checked"> <input type="radio" name="mGender" value="n" checked="checked"> <span class="ico"></span>선택안함</label>
											</td>
										</tr>
										<tr class="birth field_birth">
											...
											<td>
												<div class="birth_day">
													<input type="text" name="mBirth" id="birth_year" pattern="[0-9]*" value="" label="생년월일" size="4" maxlength="4" placeholder="YYYY">
													<!-- birth_year -->
													<span class="bar"></span> <input type="text" name="mBirth" id="birth_month" pattern="[0-9]*" value="" label="생년월일" size="2" maxlength="2" placeholder="MM">
													<!-- birth[] -->
													<span class="bar"></span> <input type="text" name="mBirth" id="birth_day" pattern="[0-9]*" value="" label="생년월일" size="2" maxlength="2" placeholder="DD">
													<!-- birth[] -->
												</div>
												<p class="txt_guide">
											...
											<td>
												<div class="group_radio">
													<span class="radio_wrapper">
														<label> <input type="radio" name="recommend" id="recommendId" label="추천인아이디"> <span class="ico"></span>추천인 아이디</label>
													</span>
													<span class="radio_wrapper">
														<label> <input type="radio" name="recommend" id="eventName" label="참여이벤트명"> <span class="ico"></span>참여 이벤트명</label>
													</span>
												</div>
											...
											<td>
												...
												<div class="check">
													<label class="check_agree label_all_check label_block">
														<input type="checkbox" name="agree_allcheck"> <span class="ico"></span>전체 동의합니다.
													</label>
													<p class="sub">선택항목에 동의하지 않은 경우도 회원가입 및 일반적인 서비스를 이용할 수 있습니다.</p>
												</div>
												<div class="check_view">
													<label class="check_agree label_block"> <input type="checkbox" value="" name="agree" required="" label="이용약관"> <span class="ico"></span>이용약관 동의 <span class="sub">(필수)</span></label>
																...
																<table cellpadding="0" cellspacing="0" width="100%">
																	...
																	<tbody>
																		<tr>
																			...
																			<br>부정이용 방지를 위하여 30일 동안 보관 (아이디, 휴대폰 번호) 후 파기</td>
																		</tr>
																		<tr>
																			<td>거점 기반 서비스 제공</td>
																		</tr>
