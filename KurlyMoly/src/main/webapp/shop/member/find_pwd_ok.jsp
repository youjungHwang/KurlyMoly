...
<%
	String userid = null;
	if (session.getAttribute("userid") != null) { // userid != sql에 저장된 이름??? m_userid로 안해도 되는건지 체크 필요
                    ...
                    <ul class="menuRight list_menu">
                        ...
                        <li class="menu lst">
                            ...
                            <ul class="sub">
                                ...
                                <li>
                                    <a href="../mypage/qna.html">1:1 문의</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div id="content" style="padding-bottom: 120px;">
                    ...
                    <div class="section_login">
                        ...
                        <div class="layer_parent">
                            <div id="certPopLayer">
                                <div id="certFrameLayer"><iframe id="certFrame" name="certFrame" src="about:blank" scrolling="no" frameborder="0"></iframe></div>
                        ...
                        <div class="write_form find_view">
                            <form name="certForm" method="post" action="">
                                ...
                                <input type="hidden" name="m_id" value="nah2ee">
                                <input type="hidden" name="otp" value="">
                                <img class="thumb" src="../../img/login/img_pw_find_email.webp" alt="이메일 찾기">
                                <p class="desc">이메일로 인증 완료후<br>비밀번호를 재발급 받으세요!</p>
                                <p class="info">입력하신 ()으로 인증번호가 발송되며, 인증 후 비밀번호가 재발급됩니다. 전송량이 많은 경우 이메일 전송이 지연될 수 있습니다.</p>
