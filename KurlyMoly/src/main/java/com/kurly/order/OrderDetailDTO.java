...
public class OrderDetailDTO {
	...
	private Long odIdx; // 주문내역번호
	private Long odOrderidx; // 주문번호 // OrderDTO. foreign key
	private Long odProductidx; // 상품번호 // ProductDTO. foreign key
	...
	public void setOdIdx(Long odIdx) {
		this.odIdx = odIdx;
	}
	public Long getOdOrderidx() {
		return odOrderidx;
	}
	public void setOdOrderidx(Long odOrderidx) {
		this.odOrderidx = odOrderidx;
	}
	public Long getOdProductidx() {
		return odProductidx;
	}
	public void setOdProductidx(Long odProductidx) {
